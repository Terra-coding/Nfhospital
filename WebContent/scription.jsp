        ...
        <main id="content" class="myPage replaceUtilMenu"> 
            ...
            <div>
                <ul class="tab_ul_section03">
                    <li id="info_tab1" >
                        <a href="${pageContext.request.contextPath}/NewReservation.re" style="color: #495164;" >진료예약현황</a>
                    </li>
                    <li id="info_tab1" >
                        <a href="${pageContext.request.contextPath}/PreReservation.re" style="color: #495164;">이전진료기록</a>
                    </li>
                    <li id="info_tab1" class="on">
                        <a href="${pageContext.request.contextPath}/Scription.re" >처방전발급</a>
                    </li>
                </ul>
                <div id="info_areal" style="position:relative;">
                    <h5 class="tit_h5">처방전조회</h5>
                    <span class="bh_btn_blue_yk1">
                        <a href="${pageContext.request.contextPath}/Reservation.re">추가진료예약</a>
                    </span>
